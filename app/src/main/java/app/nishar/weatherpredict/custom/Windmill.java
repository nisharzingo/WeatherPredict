package app.nishar.weatherpredict.custom;
...
public class Windmill extends View {
    ...
    private void drawPillar(Canvas canvas) {
        ...
        mPillarPath.lineTo(mCenterPoint.x+width/90,mCenterPoint.y-width/90);
        mPillarPath.lineTo(mCenterPoint.x+width/35,height-height/35);
        mPillarPath.quadTo(mCenterPoint.x,height,mCenterPoint.x-width/35,height-height/35);
        mPillarPath.close();
